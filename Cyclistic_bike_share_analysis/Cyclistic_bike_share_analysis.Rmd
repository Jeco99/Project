...
author: "Jerricco John Cabunagan"
date: "11/10/2022"
...
#### Business Tasks:
To analyze the annual members and casual riders use cyclistic bikes differently to design a new marketing strategy to convert casual riders into annual members.


#### Stakeholders:
- Primary Stakeholder
   - Lilo Moreno - the director of marketing and your manager

- Secondary Stakeholder
   - Cyclistic marketing analytics team - a team of data analyst who are responsible for collecting, analyzing, and a reporting data that helps guide Cyclistic marketing strategy.
   - Cyclistic executive team - the notoriously detail-oriented executive team will decide whether to approve the recommended marketing program.
  

## Prepare Phase
 The Previous 12 month of data located at this [link](https://divvy-tripdata.s3.amazonaws.com/index.html). It's made available in public by the Motivate International Inc. under this [license](https://ride.divvybikes.com/data-license-agreement). The riders' personally identifiable information has been disclose under the data-privacy issues. This means that the cannot be able to connect pass purchases to credit card numbers to determine if casual riders live in the Cyclistic service are or if they have purchased multiple single passes. The data is original and reliable since its comes from the company. 
 
 
 The data was organized based on the date from (November 2021 to October 2022) and stored in csv file format.There is a  13 columns in the dataset namely:
...
## Process phase
 R is the tool to use in cleaning and manipulating the data. Excel is not the best choice for the data that have a million data. There is no question regarding the integrity of the data since its belong to the company. I dropped the columns that doesn't needed on my analysis.
...
## Analyze Phase
  The data organized based on the needed columns for analyze.
...
##### Insight
During the season, Spring has the highest average ride length with a 37.42 minute. 
Most use type of bike is electric bike with a 2,935,552 total of users.
Afternoon is the busiest time of day with an average of 36.86 minutes.
Sunday is the most spent time with an average of 39.16 minutes. Its means that most of people are on free time or no work.

##### Recommendation
-	Give discount to the member user who took the longest ride in minutes.
-	The team must have focus on the busiest time.
-	The member who mostly use the product can gain a point.
